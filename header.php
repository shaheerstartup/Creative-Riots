...
<body>
    ...
    <div id="canvas" onclick="enableScroll()"></div>
    <div class="loader">
            ...
            <ul>
                <li>
                    <a href="<?php echo esc_url(home_url('/')); ?>"
                        class="link <?php if (is_front_page())
                            echo 'active'; ?>">INTRO <span></span></a>
                </li>
                <li>
                    <a href="<?php echo esc_url(home_url('/who')); ?>"
                        class="link <?php if (is_page('who'))
                            echo 'active'; ?>">WHO <span></span></a>
                </li>
                <li>
                    <a href="<?php echo esc_url(home_url('/what')); ?>"
                        class="link <?php if (is_page('what'))
                            echo 'active'; ?>">WHAT <span></span></a>
                </li>
                <li>
                    <a href="<?php echo esc_url(home_url('/work')); ?>"
                        class="link <?php if (is_page('work'))
                            echo 'active'; ?>">WORK <span></span></a>
                </li>
                <li>
                    <a href="<?php echo esc_url(home_url('/contact')); ?>"
                        class="link <?php if (is_page('contact'))
    ...
    <section class=".section1 parallax-container parallax">
        <div class="navbar">
            <div class="logo">
